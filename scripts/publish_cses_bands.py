...
def main():
 ...
 if args.write:
  (D/'published_bands.json').write_text(json.dumps(dict(method='cses-reviewed-v1',scope='local-review-candidate',statistical_model='disabled: count semantics and release cohorts unverified',problems=result),indent=2)+'\n')
